        ...
        React.createElement('div', { className: 'page-content' },
            React.createElement('div', { className: 'card' },
                ...
                isLoading ? React.createElement('div', { className: 'loading' },
                    ...
                    React.createElement('div', { className: 'table-container iuh-grades-table' },
                        React.createElement('div', { className: 'table-scroll-wrapper' },
                            React.createElement('table', { className: 'table table-bordered text-center grades-table-iuh' },
                                ...
                                React.createElement('tbody', null,
                                    ...
                                    gradesData.semesters ? gradesData.semesters.map((semester, semIndex) => [
                                        // Semester header row
                                        ...
                                        ...semester.subjects.map((subject, subIndex) =>
                                            React.createElement('tr', {
                                                ...
                                                React.createElement('td', {
                                                    className: `diem-tong-ket ${subject.diemTongKet >= 8.5 ? 'excellent' :
                                                        subject.diemTongKet >= 7.0 ? 'good' :
                                                            subject.diemTongKet >= 5.5 ? 'average' : 'poor'
                                                        }`
                                                ...
                                                React.createElement('td', null,
                                                    React.createElement('span', {
                                                        className: `grade-badge ${(subject.diemTongKet || subject.grade) >= 8.5 ? 'grade-excellent' :
                                                            (subject.diemTongKet || subject.grade) >= 7.0 ? 'grade-good' :
                                                                (subject.diemTongKet || subject.grade) >= 5.5 ? 'grade-average' :
                                                                    'grade-poor'
                                                            }`
                                                    }, subject.xepLoai || (
                                                        (subject.diemTongKet || subject.grade) >= 8.5 ? 'Giỏi' :
                                                            (subject.diemTongKet || subject.grade) >= 7.0 ? 'Khá' :
                                                                (subject.diemTongKet || subject.grade) >= 5.5 ? 'Trung bình' : 'Yếu'
                                                    ))
                                                ),
                                        ...
                                        semester.summary ? React.createElement('tr', {
                                            ...
                                            React.createElement('td', {
                                                ...
                                                React.createElement('div', { className: 'semester-summary' },
                                                    React.createElement('div', { className: 'summary-grid' },
                                                        React.createElement('div', { className: 'summary-column' },
                                                            React.createElement('div', { className: 'summary-item' },
                                                                React.createElement('span', { className: 'summary-label' }, 'Điểm TB học kỳ hệ 10:'),
                                                                React.createElement('span', { className: 'summary-value' }, semester.summary.diemTrungBinhHocKy10)
                                                            ),
                                                            React.createElement('div', { className: 'summary-item' },
                                                                React.createElement('span', { className: 'summary-label' }, 'Điểm TB học kỳ hệ 4:'),
                                                                React.createElement('span', { className: 'summary-value' }, semester.summary.diemTrungBinhHocKy4)
                                                            ),
                                                            React.createElement('div', { className: 'summary-item' },
                                                                React.createElement('span', { className: 'summary-label' }, 'Tổng số tín chỉ đăng ký:'),
                                                                React.createElement('span', { className: 'summary-value' }, semester.summary.tongSoTinChiDangKy)
                                                            ),
                                                            React.createElement('div', { className: 'summary-item' },
                                                                React.createElement('span', { className: 'summary-label' }, 'Tổng số tín chỉ đạt:'),
                                                                React.createElement('span', { className: 'summary-value' }, semester.summary.tongSoTinChiDat)
                                                            ),
                                                            React.createElement('div', { className: 'summary-item' },
                                                                React.createElement('span', { className: 'summary-label' }, 'Xếp loại học lực học kỳ:'),
                                                                React.createElement('span', { className: 'summary-value classification' }, semester.summary.xepLoaiHocLucHocKy)
                                                            )
                                                        ),
                                                        React.createElement('div', { className: 'summary-column' },
                                                            React.createElement('div', { className: 'summary-item' },
                                                                React.createElement('span', { className: 'summary-label' }, 'Điểm TB tích lũy hệ 10:'),
                                                                React.createElement('span', { className: 'summary-value' }, semester.summary.diemTrungBinhTichLuy10)
                                                            ),
                                                            React.createElement('div', { className: 'summary-item' },
                                                                React.createElement('span', { className: 'summary-label' }, 'Điểm TB tích lũy hệ 4:'),
                                                                React.createElement('span', { className: 'summary-value' }, semester.summary.diemTrungBinhTichLuy4)
                                                            ),
                                                            React.createElement('div', { className: 'summary-item' },
                                                                React.createElement('span', { className: 'summary-label' }, 'Tổng số tín chỉ tích lũy:'),
                                                                React.createElement('span', { className: 'summary-value' }, semester.summary.tongSoTinChiTichLuy)
                                                            ),
                                                            React.createElement('div', { className: 'summary-item' },
                                                                React.createElement('span', { className: 'summary-label' }, 'Tổng số tín chỉ không tính đến hiện tại:'),
                                                                React.createElement('span', { className: 'summary-value' }, semester.summary.tongSoTinChiKhongTinhDenHienTai || 0)
                                                            ),
                                                            React.createElement('div', { className: 'summary-item' },
                                                                React.createElement('span', { className: 'summary-label' }, 'Xếp loại học lực tích lũy:'),
                                                                React.createElement('span', { className: 'summary-value classification' }, semester.summary.xepLoaiHocLucTichLuy)
                                                            )
                                                        )
                                                    )
                                                )
...
function renderSubjectRow(subject, index) {
    return React.createElement('tr', {
        ...
        React.createElement('td', { className: 'diem-cuoi-ky' }, subject.diemCuoiKy || ''),
        React.createElement('td', {
            className: `diem-tong-ket ${subject.grade >= 8.5 ? 'excellent' :
                subject.grade >= 7.0 ? 'good' :
                    subject.grade >= 5.5 ? 'average' : 'poor'
                }`
        }, subject.grade),
