...
const SIDEBAR_ITEMS = [
    {
        ...
        onClick: () => {
            ...
            const baseUrl =
                ...
                window.location.pathname.replace('/GradesPage.html', '');
                  ...
                  React.createElement(
                      ...
                      React.createElement(
                          ...
                          React.createElement(
                              ...
                              {
                                  className:
                                      'table table-bordered text-center grades-table-iuh',
                              },
                              React.createElement(
                                  'thead',
                                  null,
                                  ...
                                  React.createElement(
                                      ...
                                      React.createElement(
                                          ...
                                          {
                                              rowSpan: 3,
                                              className: 'tenlhp-col',
                                          },
                                          'Tên môn học/học phần',
                                      ),
                                      React.createElement(
                                          'th',
                                          { rowSpan: 3, className: 'stc-col' },
                                          'Số tín chỉ',
                                      ),
                                      React.createElement(
                                          'th',
                                  ...
                                  React.createElement(
                                      ...
                                      React.createElement(
                                          'th',
                                          { colSpan: 4, className: 'lt-heso1' },
                                          'LT Hệ số 1',
                                      ),
                                      React.createElement(
                                          'th',
                                          { rowSpan: 2, className: 'th-1' },
                                          '1',
                                      ),
                                      React.createElement(
                                          'th',
                                          { rowSpan: 2, className: 'th-2' },
                                          '2',
                                      ),
                                      React.createElement(
                                          'th',
                                          { rowSpan: 2, className: 'th-3' },
                                          '3',
                                      ),
                                      React.createElement(
                                          'th',
                                          { rowSpan: 2, className: 'th-4' },
                                          '4',
                                      ),
                                  ),
                                  // Header row 3
                                                                      ...
                                                                      React.createElement(
                                                                          ...
                                                                          React.createElement(
                                                                              ...
                                                                              React.createElement(
                                                                                  ...
                                                                                  semester
                                                                                      .summary
                                                                                      .tongSoTinChiKhongTinhDenHienTai ||
                                                                                      0,
                                                                              ),
                                                                          ),
                                                                          React.createElement(
...
ReactDOM.render(
    React.createElement(GradesPage),
