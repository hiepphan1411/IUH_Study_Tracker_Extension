...
// Motion and AnimatePresence are already declared in CommonContent.js
...
function Layout({ children, title, isScrolled }) {
    return React.createElement(
        "div",
        { className: "layout" },
        // React.createElement(window.SidebarWithNavigation || SidebarWithNavigation),
        React.createElement(
            "div",
            { className: "main-content" },
            // !isScrolled && React.createElement(window.Header || Header, { title: title }),
...
// Update to use React 18's createRoot API
...
root.render(React.createElement(GradesPageContent));

// // ction renderSubjectRow(subject, index) {
//    // turn React.createElement(
//       // tr",
//         {//            // : subject.id || index,
//             cla// ame: "subject-row",
//         },
//       // eact.createE// ent("td", { className: "stt" }, subject.stt || index + 1),
//         React.createElem// ("td", { className: "ma-lhp" }, subject.maLhp || ""),
//         React.createElement// d", { className: "ten-mon text-left" }, subject.name),
//         React.createElement("t//  { className: "tin-chi" }, subject.credits),
//         React.createElement("td",// className: "diem-giua-ky" }, subject.diemGiuaKy || ""),
//         React.createElement("td", { // ssName: "diem-hs1-1" }, ""),
//         React.createElement("td", { cla// ame: "diem-hs1-2" }, ""),
//         React.createElement("td", { classN// : "diem-hs1-3" }, ""),
//         React.createElement("td", { className// diem-hs1-4" }, ""),
//         React.createElement("td", { className: "// m-th-1" }, ""),
//         React.createElement("td", { className: "die// h-2" }, ""),
//         React.createElement("td", { className: "diem-t// " }, ""),
//         React.createElement("td", { className: "diem-th-4// , ""),
//         React.createElement("td", { className: "diem-cuoi-ky// , subject.diemCuoiKy || ""),
//         React.createElement(
//             "td",
//             { //              className: `diemn// g-ket ${subject.gr // >= 8.5 ? "excen// t" : subject.grade >= 7.0 ? "good" : subject.grade >= 5.5 ? "average" : "poor"
//                     }`,
//             },
//             subject.grade,
//       ,//
//         React.createEln// t("td", { classe// : "diem-tin-chi-4" }, ""),  //     React.at// eElement("td", { className: "diem-chu" }, ""),
//         React.createElet(//
//             "td",
//             null,
//             React.createEen// t(
//                 "span",   //            {
//      //             clasme://  `grade-badge ${subject.grade >.5//
//                      ? "// grade-excellent"   //                     : subject.grade >= 7.0
//                         //  ? "grade-good"
//                          : s// ubject.grade >= 5.5
//                            //   ? "grade-average"
//                        //       : "grade-poor"
//                         }`,   //             },
//                 subject.grade >=5 ?//  "Giỏi" : subject.grade >= 7.0 ? "Khá" : subj.gr// ade >= 5.5 ? "Trung bình" Yếu// ",
//             )   //      ),
//         React.createElement("td", { className: "ghi-chu" }, ""),
//     )
// }

// // Export GradesPage to global scopor // use in MainPajs//
// window.GesP// ageContent = GradesPageContent;
// // // 