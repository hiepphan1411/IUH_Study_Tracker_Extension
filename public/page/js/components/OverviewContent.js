...
function SubjectGradeStatistic({ subjects }) {
                ...
                if (
                    ...
                    if (selectedScale === '10') {
                        ...
                        grade = thangDiem4
                            ...
                            : convertGrade(
                                  parseFloat(diemTongKet.replace(',', '.')),
                                  '4',
                              );
                    }
    ...
    const getTooltipFormatter = () => {
        const unit =
            selectedScale === '4' ? 'điểm (thang 4)' : 'điểm (thang 10)';
        ...
        const formattedData = results
            .map((hocKy) => {
                ...
                const avgRow = hocKy.monHoc.find(
                    (mon) =>
                        mon.STT &&
                        mon.STT.includes('Điểm trung bình học kỳ hệ'),
                );
...
function SubjectResultStatistics({ subjects }) {
    ...
    const totalSubjects = subjectData.reduce(
        ...
        const loadData = async () => {
            ...
            try {
                ...
                if (diemJson) {
                    ...
                    console.log(
                        'Thống kê: ',
                        countGradesByLetter(transformedSubjects),
                    );
